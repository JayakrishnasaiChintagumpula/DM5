...
def question7():
    ...
    # type: explain_string
    answers['(i) Best classifier, explain'] = "Because it correctly detects more positive examples and has a better balance between precision and recall, C2 is a superior classifier than C1, as evidenced by its significantly higher recall/TPR and F1-measure."
